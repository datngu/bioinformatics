---
layout: post
title:  "Các Công Nghệ Đọc Genome: Từ Sanger Đến Long-Read và Sự Tiến Hoá Qua Các Thế Hệ"
author: dat
...
**Câu hỏi 1 — Trình tự là gì?** Trình tự DNA của sinh vật này, vùng gen này, hay cá thể này trông như thế nào? Đây là câu hỏi đòi hỏi phương pháp giải trình tự.
...
Mỗi thế hệ công nggenomeomics đã mở rộng khả năng trả lời từng loại câu hỏi này theo những cách khác nhau. Bảng 1.1 tóm tắt ánh xạ tổng quát.
...
| Toàn genomeome, độ sâu cao | Short-read NGS (Illumina) | Không đọc được vùng lặp dài |
...
![Hình 1.1: Tam giác đánh đổi giữa ba thế hệ công nggenomeomics]({{ site.baseurl }}/assets/my_figs/ds/genomics-fig1-1-tradeoff.png)
...
**WGS** (Whole Genome Sequencing, giải trình tự toàn genomeome): thay thế SNP array khi cần phát hiện cả biến thể phổ biến lẫn biến thể hiếm.
...
**RNA-seq** (giải trình tự transcriptome): cDNA được tổng hợp từ RNA rồi giải trình tự bằng NGS, cho phép đo mức biểu hiện gen với độ phân giải cao hơn nhiều so với vi mảng biểu hiện gen.
...
**Kỷ nguyên Short-read NGS (2005-nay)**: thông lượng cao, đọc ngắn. Câu hỏi khả thi: toàn bộ biến thể nucleotide trong genome; biểu hiện gen toàn genome; vị trí gắn protein điều hoà. Ứng dụng chính: WGS, RNA-seq, epigenomics.
...
![Hình 6.1: Đường thời gian các cột mốc công nggenomeomics]({{ site.baseurl }}/assets/my_figs/ds/genomics-fig6-1-timeline.png)
*Hình 6.1. Đường thời gian các cột mốc quan trọng trong lịch sử công nggenomeomics từ 1977 đến 2023.*
